<?php
  ...
  function select_fitness_apk_data() { // Shows first 3 communication in Database
...
<html>
<head>
  <title>Health and Fitness Apps - Download APKs from APK House</title>
...
<body id="top-home">
  ...
  <div class="container">
      ...
      <center><h2 id="main_heading" class="img-rounded" style="padding-top: 20px; padding-bottom:20px;">Viewing All Fitness and Health Apps <small class="bg-primary img-rounded" style="padding: 5px;">Stay Healthy</small></h2></center>
