<?php
  ...
  function select_games_apk_data() { // Shows games in Database
...
<html>
<head>
  <title>Games for Android - Download APKs from APK House</title>
...
<body id="top-home">
  ...
  <div class="container">
      ...
      <center><h2 id="main_heading" class="img-rounded" style="padding-top: 20px; padding-bottom:20px;">Viewing All Games for Android <small class="bg-primary img-rounded" style="padding: 5px;">Hottest Games</small></h2></center>
    

    <br>
    <!-- for showing the description of apps in tooltip -->
    <script> 
