<?php
  ...
  function select_communication_apk_data() { // Shows first 3 communication in Database
...
<html>
<head>
  <title>Comunication Apps - Download APKs from APK House</title>
...
<body id="top-home">
  ...
  <div class="container">
      ...
      <center><h2 id="main_heading" class="img-rounded" style="padding-top: 20px; padding-bottom:20px;">Viewing All Communication Apps <small class="bg-primary img-rounded" style="padding: 5px;">Connect with your loved ones</small></h2></center>
    ...
    <?php
      $data = select_communication_apk_data();
