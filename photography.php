<?php
  ...
  function select_photo_apk_data() { // Shows photo in Database
...
<html>
<head>
  <title>Photography Apps - Download APKs from APK House</title>
...
<body id="top-home">
  ...
  <div class="container">
      ...
      <center><h2 id="main_heading" class="img-rounded" style="padding-top: 20px; padding-bottom:20px;">Viewing All Photography Apps for Android <small class="bg-primary img-rounded" style="padding: 5px;">Prefect Photography Tools</small></h2></center>
